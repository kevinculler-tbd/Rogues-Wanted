...
import main.java.Model.Items.Equipment.Weapons.Fists;
...
public class Player extends ActorCharacter {
	...
	public String getStatus(){
		...
		for (AbstractEquipment eq:getEquipedItems()){
		...
		ret = ret+"\nCurrent weapon: "+weapon.getName()+" - "+weapon.getDescription()+"\n";

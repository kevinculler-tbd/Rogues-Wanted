...
public class ActorCharacter extends AbstractActorObject{
	...
	protected AbstractWeapon defaultWeapon;
	...
	public AbstractWeapon getDefaultWeapon() {
		return defaultWeapon;
	}
	public void setDefaultWeapon(AbstractWeapon defaultWeapon) {
		this.defaultWeapon = defaultWeapon;
	}
	public boolean checkDeath(){
		if(hp<1){
			environment.removePossession(this);
			return true;
		}
		return false;
	}

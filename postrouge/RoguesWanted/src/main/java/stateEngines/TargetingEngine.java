...
public class TargetingEngine extends AbstractEngine{
	...
	private int range;
	private AbstractActorObject looker;
	
	public TargetingEngine(AbstractEngine lstEng) {
		super(lstEng);
		// TODO Auto-generated constructor stub
	}
	public TargetingEngine(AbstractEngine lstEng, AbstractAction act, int actionRange, AbstractActorObject actorLooking) {
		super(lstEng);
...
//					 }
	...
	public AbstractEngine takeStep() {
		...
		case CONFIRM:
			...
			tMessage = targetForAction.doConfirm(targetIcon, target);
			if(tMessage != null){
				actionMessage = tMessage;
			}
			lastEngine.setActionMessage(actionMessage);
			ret = lastEngine;
			targetIcon.getEnvironment().removePossession(targetIcon);
			break;
		}
